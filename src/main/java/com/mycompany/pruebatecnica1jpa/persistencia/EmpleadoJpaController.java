...
public class EmpleadoJpaController implements Serializable {
    ...
    public List<Empleado> findEmpleadosByCargo(String cargo) {
        EntityManager em = getEntityManager();
        try {
            // Consulta JPQL para obtener los empleados por cargo, excluyendo los empleados marcados como borrados.
            TypedQuery<Empleado> query = em.createQuery(
                    "SELECT e FROM Empleado e WHERE e.cargo = :cargo AND e.borrado = false", Empleado.class);
